...
function Index() {
  useNavSideBar([
    {
      path: "/assign-role-user#preview",
      label: "Service API",
    },
    { path: "/assign-role-user#url", label: "URL" },
    { path: "/assign-role-user#reqParam", label: "Request Param" },
    { path: "/assign-role-user#response", label: "Response" },
    {
      path: "/assign-role-user#example-response",
      label: "Example Response",
      items: [
        { path: "/assign-role-user#success", label: "Success" },
        { path: "/assign-role-user#failed", label: "Failed" },
      ],
    },
  ]);
  useScrollIntoView();

  const importCode = `POST /users/{username}/assign`;
...
`,
    ...
    <div>
      ...
      <div className="space-y-2" id="#preview">
        ...
        The API entry point for Backend to get all parameter is{" "}
          <b>POST /users/{`username`}/assign</b> This API endpoint is implemented
  ...
  "responseMessage": "SUCCESS"
        ...
        <CodeBlocks
          code={`{
  "requestId": "ae2e36fa0baa47269633189a19fbb00c",
  "responseCode": "X01",
