...
function Index() {
  useNavSideBar([
    {
      path: "/get-all-service#preview",
      label: "Service API",
    },
    { path: "/get-all-service#url", label: "URL" },
    { path: "/get-all-service#reqParam", label: "Request Param" },
    { path: "/get-all-service#response", label: "Response" },
    {
      path: "/get-all-service#example-response",
      label: "Example Response",
    },
  ]);
  useScrollIntoView();

  const importCode = `GET /services`;
  ...
  const requestParameter = [
    {
      ...
      length: "100",
      mandatory: "Yes",
      description: `Role Code or Menu Code.
...
If the given roleCode or menuCode does not have access to the service, it will return false, else true.`,
  ...
  const responseData = [
    ...
    {
      property: "content.serviceCode",
      dbMapping: "SYS_ SERVICE.SERVICE _CODE",
    ...
    },
    {
    ...
    },
      {
        ...
        dbMapping: "SYS_SERVICE.DESCRIPTION",
        sampleValues: "To get users ",
      },
  ];
    ...
    <div>
      ...
      <div className="space-y-2" id="#preview">
        ...
        <p>
          ...
          <b>GET /services</b> This API endpoint is implemented inside{" "}
      ...
      <div className="space-y-2" id="#example-response">
        ...
        <CodeBlocks
          code={`{
 "requestId": "3ef5adf25cc14259b8f3a5e7508924ba",
    "responseCode": "00",
    ...
    "data": {
        ...
        <CodeBlocks
          code={`{
    "requestId": "27211c03666a4a9eb0b033e2849b463c",
    "responseCode": "400",
