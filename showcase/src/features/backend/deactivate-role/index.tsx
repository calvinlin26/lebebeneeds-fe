...
function Index() {
  useNavSideBar([
    {
      path: "/deactive-role#preview",
      label: "Service API",
    },
    { path: "/deactive-role#url", label: "URL" },
    { path: "/deactive-role#reqParam", label: "Request Param" },
    { path: "/deactive-role#response", label: "Response" },
    {
      path: "/deactive-role#example-response",
      label: "Example Response",
      items: [
        { path: "/deactive-role#success", label: "Success" },
        { path: "/deactive-role#failed", label: "Failed" },
      ],
    },
  ]);
  useScrollIntoView();

  const importCode = `DELETE /roles/{roleCode}`;
  ...
  return (
    <div>
      ...
      <div className="space-y-2" id="#preview">
        ...
        <p>
          ...
          <b>DELETE /roles/{`{roleCode}`}</b> This API endpoint is implemented
    ...
    "responseMessage": "SUCCESS"
        ...
        <CodeBlocks
          code={`{
    "requestId": "c2601f952e024d54b5bae68efd13e2e5",
    "responseCode": "U05",
