...
function Index() {
  useNavSideBar([
    {
      path: "/add-role#preview",
      label: "Service API",
    },
    { path: "/add-role#url", label: "URL" },
    { path: "/add-role#reqParam", label: "Request Param" },
    { path: "/add-role#response", label: "Response" },
    {
      path: "/add-role#example-response",
      label: "Example Response",
      items: [
        { path: "/add-role#success", label: "Success" },
        { path: "/add-role#failed", label: "Failed" },
      ],
    },
  ]);
  useScrollIntoView();

  const importCode = `POST /roles`;
  ...
  return (
    <div>
      ...
      <div className="space-y-2" id="#preview">
        ...
        <p>
          ...
          <b>POST /roles.</b> This API endpoint is implemented inside
    ...
    "responseMessage": "SUCCESS"
        ...
        <CodeBlocks
          code={`{
    "requestId": "68022238986147fca016599e0c1ab70d",
    "responseCode": "U04",
    "responseMessage": "U04 - Role already exist"
}`}
          language="js"
        />
      </div>
