...
function Index() {
  useNavSideBar([
    {
      path: "/add-user#preview",
      label: "Service API",
    },
    { path: "/add-user#url", label: "URL" },
    { path: "/add-user#reqParam", label: "Request Param" },
    { path: "/add-user#response", label: "Response" },
    {
      path: "/add-user#example-response",
      label: "Example Response",
      items: [
        { path: "/add-user#success", label: "Success" },
        { path: "/add-user#failed", label: "Failed" },
      ],
    },
  ]);
  useScrollIntoView();

  const importCode = `POST /users`;
    ...
    <div>
      ...
      <div className="space-y-2" id="#preview">
        ...
        <p>
          ...
          <b>POST /users.</b> This API endpoint is implemented inside
  ...
  "responseMessage": "SUCCESS"
        ...
        <CodeBlocks
          code={`{
  "requestId": "426e948903bb409a9002ce0aed87fcb7",
  "responseCode": "U01",
  "responseMessage": "U01 - User already exist"
}`}
          language="js"
        />
      </div>
