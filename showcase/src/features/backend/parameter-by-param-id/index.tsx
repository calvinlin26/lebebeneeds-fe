...
function Index() {
  useNavSideBar([
    {
      path: "/parameter-by-param-id#preview",
      label: "Service API",
    },
    { path: "/parameter-by-param-id#url", label: "URL" },
    { path: "/parameter-by-param-id#reqParam", label: "Request Param" },
    { path: "/parameter-by-param-id#response", label: "Response" },
    {
      path: "/parameter-by-param-id#example-response",
      label: "Example Response",
      items: [
        { path: "/parameter-by-param-id#success", label: "Success" },
        { path: "/parameter-by-param-id#failed", label: "Failed" },
      ],
    },
  ]);
  useScrollIntoView();

  const importCode = `GET /frontend/params`;
    ...
    <div>
      <div className="space-y-2">
        <h1 className="scroll-m-20 text-3xl font-bold tracking-tight">
          Frontend - Get Parameter By Param ID
        </h1>
      </div>
      <br />
      <div className="space-y-2" id="#preview">
        ...
        <p>
          ...
          <b>GET /frontend/params/</b> This API endpoint is implemented inside{" "}
      ...
      <div className="space-y-2">
        ...
        <CodeBlocks
          code={`{
  "requestId": "4337409299b6438cb633f2d90dc6652b",
  "responseCode": "00",
