...
function Index() {
  useNavSideBar([
    {
      path: "/assign-service-role#preview",
      label: "Service API",
    },
    { path: "/assign-service-role#url", label: "URL" },
    { path: "/assign-service-role#reqParam", label: "Request Param" },
    { path: "/assign-service-role#response", label: "Response" },
    {
      path: "/assign-service-role#example-response",
      label: "Example Response",
      items: [
        { path: "/assign-service-role#success", label: "Success" },
        { path: "/assign-service-role#failed", label: "Failed" },
      ],
    },
  ]);
  useScrollIntoView();

  const importCode = `POST /roles/{roleCode}/assign-service`;
...
`,
  ...
  return (
    <div>
      ...
      <div className="space-y-2" id="#preview">
        ...
        The API entry point for Backend to get all parameter is{" "}
          <b>POST /roles/{`roleCode`}/assign-service</b> This API endpoint is implemented
    ...
    "responseMessage": "SUCCESS"
        ...
        <CodeBlocks
          code={`{
    "requestId": "8ebeb6c993ee4f409431f9acc8100290",
    "responseCode": "400",
    "responseMessage": "Validation failure"
}`}
          language="js"
        />
      </div>
