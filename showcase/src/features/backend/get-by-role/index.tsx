...
function Index() {
  useNavSideBar([
    {
      path: "/get-by-role#preview",
      label: "Service API",
    },
    { path: "/get-by-role#url", label: "URL" },
    { path: "/get-by-role#reqParam", label: "Request Param" },
    { path: "/get-by-role#response", label: "Response" },
    {
      path: "/get-by-role#example-response",
      label: "Example Response",
    },
  ]);
  useScrollIntoView();

  const importCode = `GET /roles/{roleCode}`;
    ...
    <div>
      ...
      <div className="space-y-2" id="#preview">
        ...
        <p>
          ...
          <b>GET /roles/{`roleCode`}</b> This API endpoint is implemented inside{" "}
