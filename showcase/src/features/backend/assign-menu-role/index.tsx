...
function Index() {
  useNavSideBar([
    {
      path: "/assign-menu-role#preview",
      label: "Service API",
    },
    { path: "/assign-menu-role#url", label: "URL" },
    { path: "/assign-menu-role#reqParam", label: "Request Param" },
    { path: "/assign-menu-role#response", label: "Response" },
    {
      path: "/assign-menu-role#example-response",
      label: "Example Response",
      items: [
        { path: "/assign-menu-role#success", label: "Success" },
        { path: "/assign-menu-role#failed", label: "Failed" },
      ],
    },
  ]);
  useScrollIntoView();

  const importCode = `POST /roles/{roleCode}/assign-menu`;
  ...
  const reqBody = [
    {
      ...
      length: "-",
      mandatory: "Yes",
      description: "List of menu codes",
      sampleValues: `[
    "BACK_OFFICE",
    "FRONT_OFFICE "
]`,
    ...
    <div>
      ...
      <div className="space-y-2" id="#preview">
        ...
        The API entry point for Backend to get all parameter is{" "}
          <b>POST /roles/{`roleCode`}/assign-menu</b> This API endpoint is implemented
